...
const isNum = (input) => {
  if (input.toString().match(/[1-9]/g) !== null) {
    return true;
  } else {
    return false;
  }
...
const citiesAtoJ = (arr) => {
  let resultArr = [];
  for (let city of arr) {
    if (city.match(/\b(?<!\s)[A-J].*?\b/g) !== null) {
      resultArr.push(city);
    }
  }
  return resultArr;
...
const matchMonth = (input) => {
  ...
  if (input.match(/\b(Oct)\b/g) !== null) {
    return true;
  } else if (input.match(/\b(oct)\b/g) !== null) {
    return true;
  } else if (input.match(/\b(October)\b/g) !== null) {
    return true;
  } else if (input.match(/\b(october)\b/g) !== null) {
    return true;
  } else {
